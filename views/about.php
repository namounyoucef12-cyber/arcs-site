<section class="page-hero">
    ...
    <h1>Academie de Renforcement des Competences et du Savoir</h1>
...
<section class="detail-layout">
    ...
    <aside class="info-panel">
        ...
        <dl class="meta-list vertical">
            ...
            <div><dt>Publics</dt><dd>Particuliers, salaries, demandeurs d emploi, entreprises</dd></div>
            <div><dt>Domaines</dt><dd>Langues, certifications, examens</dd></div>
        </dl>
    </aside>
</section>
